            ...
            <section>
              ...
              {orgCourses.length === 0 ? (
                <div className="bg-white rounded-3xl border border-slate-100 p-12 text-center shadow-sm">
                  ...
                  <p className="text-slate-500 font-medium">Ο καθηγητής σου δεν έχει ανεβάσει ακόμα ύλη.</p>
                </div>
              ) : (
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-12 border-t border-slate-200/60">
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="space-y-2 text-center md:text-left">
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">EduPlatform Dashboard v1.0</p>
            <div className="flex items-center gap-4 justify-center md:justify-start">
               <a href="/terms" className="text-[11px] font-black text-slate-400 hover:text-blue-600 uppercase cursor-pointer">Οροι Χρησης</a>
               <div className="w-1 h-1 bg-slate-300 rounded-full"></div>
               <a href="mailto:info@eduplatform.gr" className="text-[11px] font-black text-slate-400 hover:text-blue-600 uppercase cursor-pointer">Βοηθεια</a>
            </div>
          </div>
